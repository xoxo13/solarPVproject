...
class CertificateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Certificate
        fields = ('cert_ID', 'certNumber', 'locationID',
        'reportNumber', 'userID', 'testStandard', 'productID', 'certIssueDate')

class ServiceSerializer(serializers.ModelSerializer):
    class Meta:
        model = Service
        fields = ('serviceID', 'serviceName','description', 'isFIrequired', 'fiFrequency', 'testStandardID')
